...
namespace Patty_CustomScenario_MOD.QoL
{
    ...
    /// <summary>
    /// Taken from <a href="https://github.com/microsoft/referencesource/blob/main/System.ServiceModel.Internals/System/Runtime/Collections/OrderedDictionary.cs"></a>
    /// <br/><br/>
    ...
    public class OrderedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary
    {
        ...
        readonly OrderedDictionary privateDictionary;
        ...
        public OrderedDictionary(IDictionary<TKey, TValue> dictionary) : base()
        {
            if (dictionary != null)
            {
