...
namespace Patty_CustomScenario_MOD.Enums
{
    public class ECharactersCountType : Enumeration
    {
        ...
        /// </summary>
        public static readonly ECharactersCountType Characters = new(1, nameof(Characters));
        /// <summary>
        /// The amount of character that will show up in the deck view.
        /// </summary>
        public static readonly ECharactersCountType Deck = new(2, nameof(Deck));
        public new static ECharactersCountType Parse(int id)
        {
            TryParse(id, out ECharactersCountType result);
            return result!;
        }
        public new static bool TryParse(int id, out ECharactersCountType result)
        {
            result = null!;
